...
- [INTRODUÇÃO](#introdução)
  ...
  - [DESCRIÇÃO](#descrição)
  - [EXPLICAÇÕES DOS MOTIVOS DAS REGRAS](#explicações-dos-motivos-das-regras)
- [REGRAS DO GRUPO HIPNOSE PRÁTICA](#regras-do-grupo-hipnose-prática)
  - [I - Publicidade em Geral](#i---publicidade-em-geral)
  - [II - Perfil Falso \(Fake\)](#ii---perfil-falso-fake)
  - [III - Atenha-se aos Assuntos do Grupo](#iii---atenha-se-aos-assuntos-do-grupo)
  - [IV - Postagem\(ns\) e Comentário\(s\)](#iv---postagemns-e-comentários)
  - [V - Postagem “Humorística”](#v---postagem-“humorística”)
  - [VI - Ofensas](#vi---ofensas)
  - [VII - Crítica\(s\)](#vii---críticas)
  - [VIII - Adicionando Amigo\(s\) ao Grupo](#viii---adicionando-amigos-ao-grupo)
  - [IX - Bate-papo](#ix---bate-papo)
- [ADMINISTRADORES DO GRUPO](#administradores-do-grupo)
- [LINKS ÚTEIS DOS MEMBROS DO HIPNOSE PRÁTICA](#links-úteis-dos-membros-do-hipnose-prática)
- [DICAS](#dicas)
...
<a name="explicações-dos-motivos-das-regras"></a>
### EXPLICAÇÕES DOS MOTIVOS DAS REGRAS

Membro(s) do grupo Hipnose Prática, (e interessados em aderir ao grupo), estas são as ~~(novas)~~ regras que passam a vigorar a partir da data de sua publicação, (17/06/2012, atualizadas dia 16/09/2016).

Devido a “mal-entendidos” ocorridos anteriormente, eu, Samej Spenser, na função de administrador deste grupo, (pura e simplesmente por ter criado o grupo a partir do meu perfil), me vi obrigado a suspender temporariamente novas publicações no grupo numa “tentativa” de conter novos “desentendimentos”. Pensei bastante sobre o que fazer para “amenizar” a situação ~~e confesso que quase deletei o grupo~~. Depois de conversar com algumas pessoas, e de receber o feedback de alguns membros por mensagens inbox, optei por incluir (mais) moderadores para me auxiliarem no “controle” e “manutenção” do grupo.
...
<a name="i---publicidade-em-geral"></a>
### I - Publicidade em Geral
...
3. Será permitido apenas um evento por anúncio. Desta forma, eventos repetidos serão deletados e seu autor notificado, valendo o mesmo que o *§* 2 da Seção I;

4. Texto(s) “bonitinho(s)”, mensagem(ns) de “bom dia” e etc., que estiver(em) ocultando uma propaganda será(ão) deletada(s) imediatamente, valendo o mesmo que o *§* 2 da Seção I;

5. Caso possua um Blog/Site, Página no Facebook, Twitter, Fórum e etc., que fale/trate sobre Hipnose, PNL, Letargia, EFT, e outros temas relativos, (desde que tratados de forma “séria”), envie uma **MENSAGEM PRIVADA** (inbox) para um dos moderadores, para que este inclua o(s) respectivo(s) link(s) na planilha do grupo Hipnose Prática;  
    ...
    3. Esta planilha será disponibilizada através de um link de visualização no Google Drive. Este link se encontra no final deste texto/documento para a simples conferência de qualquer membro do grupo;  
...
1. Perfil(is) que for(em) identificado(s) e/ou comprovado(s) como falso(s) ou “fake(s)”, serão banidos e bloqueados permanentemente e/ou terão sua solicitação de participação negada;  
    1. O mesmo vale para contas com menos de um ano no facebook, e/ou que esteja participando em mais de trinta grupos;

2. Perfil(is) com o nome de empresa, negócio e etc., será(ão) recusado(s) e/ou removido(s) do grupo;
...
2. Mensagem(ns) compartilhada(s) do perfil(is) de usuário(s) e/ou página(s) será(ão) recusados. Pois entende-se que essa prática é uma isca de “curtidas” e/ou “likes”, valendo o mesmo que o *§* 2 da Seção I. Caso queira compartilhar algum texto, imagem, link, vídeo e etc., faça-o pelo mural do grupo;
...
6. Procure utilizar o idioma corretamente, (principalmente a pontuação), para que a compreensão do mesmo seja perfeita, fácil e agradável. (Na *Publicação Hipnose Prática* no Medium tem um artigo que se aplica muito bem neste caso: *“Comunicação Efetiva Através de E-mail”*, que pode ser conferido neste link: [https://medium.com/p/43f21ab97931][2]);

7. Caso não compreenda alguma palavra e/ou termo, (gíria(s), por exemplo), utilizado por algum membro de outra nacionalidade, procure ajuda com o tradutor do Google, ([http://translate.google.com][3]), ou pergunte para quem publicou se pode utilizar outras palavras para se expressar;
...
2. Existem três maneiras para adicionar alguém no grupo:  
    ...
    2. **A SEGUNDA**, é o próprio membro do grupo adicionar um amigo que já conste em sua lista (pessoal) de amigos. Para isso, siga esses passos: **1)** Comece a escrever o nome do seu amigo, (procure respeitar as letras maiúsculas e minúsculas), no campo próprio, localizado no topo da coluna direita. **2)** Uma caixa de diálogo aparecerá com o nome do seu amigo. Selecione-o e pronto;  
...
4. **TODOS** os moderadores receberão um e-mail de notificação com a solicitação de participação no grupo, e o primeiro que acessar o grupo irá analisar o perfil e aprová-lo, (ou não, conforme [*§* 1 e 3 da Seção II][1]);
...
- Link para as Regras do grupo Hipnose Prática: [http://bit.ly/MWu9H6][15].
...
- Para que sua caixa de entrada não fique lotada com os e-mail’s do grupo, clique em "Notificações", no canto superior direito, no menu horizontal, e em seguida, clique em "Configurações". Selecione a melhor opção para seu caso;
...
- Perceba que cada vez que se clica a tecla ENTER, é adicionado seu comentário na postagem. Para que um comentário com mais de um parágrafo fique legível e "inteiro", execute um destes três procedimentos:  
    ...
    2. Escreva seu comentário em um processador de texto qualquer, (Bloco de notas, Word, Notepad++, e etc.), depois que tiver concluído seu comentário, copie-o, (Ctrl+C), e cole-o, (Ctrl+V), na postagem correspondente;  
...
- Quando se escreve TUDO em letra maiúscula, (com a tecla Caps Lock ativada), desconsiderando títulos e/ou ênfases, acaba(-se) sendo um tipo de grosseria com o leitor. É a mesma coisa que gritar com alguém. Atente-se para isso! E para ilustrar e entendermos bem o que digo, vejam essa imagem: [http://bit.ly/HShPnQ](http://bit.ly/HShPnQ);

- Como fugir dos chatos sem bloquear ninguém? - INFO Online [http://bit.ly/GHpuf9](http://bit.ly/GHpuf9);

- De uns tempos para cá, o Facebook adicionou a opção de "edição" de comentários. Logo, se você percebeu algum erro em algum comentário (seu) já postado, você pode simplesmente editá-lo. Para isso, basta posicionar o ponteiro do mouse sobre seu comentário para que um "lápis" apareça no canto superior direito do mesmo, clicando no lápis, você tem duas opções: "Editar…" e "Excluir…". Clique sobre "Editar…", modifique o que tem que ser modificado e tecle "Enter" para enviar. Note que após a edição do comentário, é adicionado à informação do comentário, à direita da data e hora que o mesmo foi publicado (informações em cinza) a palavra "Editado", e ao se clicar ali, é exibido o histórico de edições para aquele comentário. Então, independentemente da edição que se faça, (como edições "maliciosas" e/ou edições no intuito de "esconder" o que havia sido dito anteriormente), ainda será possível conferir o conteúdo anterior. Peço e solicito a utilização do "bom caráter" nas edições.
...
Para publicar uma postagem por e-mail, é bem simples: salve em sua agenda de contatos no e-mail o seguinte endereço: [hipnose@groups.facebook.com](mailto:hipnose@groups.facebook.com)
...
4. Para adicionar arquivos como .PDF's, .DOC's, .DOCX's, .ePub's e etc., basta também anexar o arquivo em questão, (somente um arquivo por e-mail);
...
- Todas as postagens e comentários no grupo são enviados por e-mail aos membros que mantiveram as notificações ativas.

- Ao receber um e-mail de uma nova postagem e/ou comentário (numa postagem já existente), basta responder ao e-mail de notificação. Sua resposta será adicionada como um novo comentário.
...
[3]: http://translate.google.com/ "Google Tradutor"
[4]: vi---ofensas
...
[14]: http://bit.ly/2cVGDDR " | Google Drive"
[15]: http://bit.ly/ "Regras do Grupo Hipnose Prática"
